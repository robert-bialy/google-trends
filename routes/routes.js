...
routes.get('/realTimeTrends', (req, res, next) => AuthenticationController.verifyToken(req, res, next), (request, response) => GoogleTrendsController.realTimeTrends(request,  response));
